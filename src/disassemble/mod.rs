use std::{collections::HashMap, fmt::Write, fs, process::exit};
...
pub fn disassemble_buffer(input_buffer: &Vec<u8>, output_buffer: &mut String) {
    /*
...
pub fn disassemble_file(file_path: &str, output_file_path: &str) {
    ...
    disassemble_buffer(&contents, &mut output_buffer);
